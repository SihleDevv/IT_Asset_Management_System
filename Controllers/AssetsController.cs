                ...
                switch (assetType)
                {
                    case "Computer":
                        newAsset = new Computer
                        {
                            ...
                            PurchasePrice = decimal.TryParse(form["PurchasePrice"], out var compPrice) ? compPrice : 0,
                    ...
                    case "Server":
                        newAsset = new Server
                        {
                            ...
                            PurchasePrice = decimal.TryParse(form["PurchasePrice"], out var servPrice) ? servPrice : 0,
                            Vendor = form["Vendor"].ToString(),
                            WarrantyExpiryDate = DateTime.TryParse(form["WarrantyExpiryDate"], out var servWarranty) ? servWarranty : null,
                            Location = form["Location"].ToString(),
                            Status = form["Status"].ToString(),
                            Notes = form["Notes"].ToString(),
                    ...
                    case "Application":
                        newAsset = new Application
                        {
                            ...
                            PurchasePrice = decimal.TryParse(form["PurchasePrice"], out var appPrice) ? appPrice : 0,
                            Vendor = form["Vendor"].ToString(),
                ...
                switch (assetType)
                {
                    case "Computer":
                        ...
                        if (existingComputer != null)
                        {
                            ...
                            existingComputer.PurchasePrice = decimal.TryParse(form["PurchasePrice"], out var compPrice) ? compPrice : existingComputer.PurchasePrice;
                    ...
                    case "Server":
                        ...
                        if (existingServer != null)
                        {
                            ...
                            existingServer.PurchasePrice = decimal.TryParse(form["PurchasePrice"], out var servPrice) ? servPrice : existingServer.PurchasePrice;
                            existingServer.Vendor = form["Vendor"].ToString();
                            existingServer.WarrantyExpiryDate = DateTime.TryParse(form["WarrantyExpiryDate"], out var servWarranty) ? servWarranty : null;
                    ...
                    case "Application":
                        ...
                        if (existingApplication != null)
                        {
                            ...
                            existingApplication.PurchasePrice = decimal.TryParse(form["PurchasePrice"], out var appPrice) ? appPrice : existingApplication.PurchasePrice;
